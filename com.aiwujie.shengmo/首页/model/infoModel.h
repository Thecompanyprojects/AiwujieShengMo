...
@property (nonatomic , copy) NSString              * dvisit_num;
...
@property (nonatomic , copy) NSString              * black_state;
...
@property (nonatomic , copy) NSString              * starchar;
@property (nonatomic , copy) NSString              * photo_lock;
