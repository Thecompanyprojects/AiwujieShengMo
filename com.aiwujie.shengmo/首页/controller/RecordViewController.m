...
-(void)createMediaData:(NSString *)media{
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",PICHEADURL,@"Api/users/MediaEdit"]  parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
