...
-(void)getinfoData{
    ...
    [manager POST:url parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        if (integer == 2000) {
            ...
            if ([responseObject[@"data"][@"match_photo"] count] != 0 && [responseObject[@"data"][@"match_introduce"] length] != 0) {
            ...
            //用于对比是否图片更改的原始数组
            [_pictureArray addObjectsFromArray:responseObject[@"data"][@"match_photo"]];
