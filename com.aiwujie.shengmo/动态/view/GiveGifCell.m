...
-(void)setModel:(GiveGifModel *)model{
    ...
    [str addAttribute:NSForegroundColorAttributeName value:MainColor range:NSMakeRange([_model.nickname length],1)];
    [str addAttribute:NSForegroundColorAttributeName value:MainColor range:NSMakeRange([_model.nickname length] + 1 + [_model.fnickname length],3)];
