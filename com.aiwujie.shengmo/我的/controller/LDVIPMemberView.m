...
-(void)setUpUI:(NSString *)type{
    ...
    if ([type intValue] == 0) {
        ...
        array = @[@"[专属]-包含普通VIP会员所有特权",@"[专属]-发消息无需邮票，无限畅聊",@"[专属]-可设置所有人无需邮票直接给我发消息",@"[专属]-年费SVIP将在“身边”推顶一个月",@"[专属]-可查看所有人历史昵称",@"[专属]-可对他人进行“详细描述”",@"[专属]-修改昵称不限次数",@"[专属]-发布的动态将自动被推荐",@"[专属]-聊天对话页显示红色昵称",@"[专属]-可编辑已发布动态",@"[专属]-各列表排名最前",@"[专属]-豪华金V标识"];
    }
