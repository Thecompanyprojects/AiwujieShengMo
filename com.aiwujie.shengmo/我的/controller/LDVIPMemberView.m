...
-(void)setUpUI:(NSString *)type{
    ...
    for (int i = 0; i < array.count; i++) {
        ...
        //更改[专属]的颜色
        [self changeWordColorTitle:label.text andTitleColor:CDCOLOR  andLoc:0 andLen:4 andLabel:label];
    ...
    if ([type intValue] == 0) {
        ...
        //更改升级无忧颜色
        [self changeWordColorTitle:warnLabel.text andTitleColor:CDCOLOR andLoc:0 andLen:5 andLabel:warnLabel];
        
        NSMutableAttributedString *attributedStr = [[NSMutableAttributedString alloc] initWithString:warnLabel.text];
        [attributedStr addAttribute:NSForegroundColorAttributeName value:CDCOLOR range:NSMakeRange(0,5)];
    ...
    if ([type intValue] == 0){
        ...
        //更改钱数的颜色
        [self changeWordColorTitle:_moneyLabel.text andTitleColor:CDCOLOR  andLoc:3 andLen:2 andLabel:_moneyLabel];
        ...
        //更改钱数的颜色
        [self changeWordColorTitle:_moneyLabel.text andTitleColor:CDCOLOR  andLoc:3 andLen:3 andLabel:_moneyLabel];
    }
    ...
    [self changeWordColorTitle:protcolLabel.text andTitleColor:CDCOLOR andLoc:protcolLabel.text.length - 6 andLen:6 andLabel:protcolLabel];
